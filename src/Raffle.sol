...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    //When should the winer picked?
    /**
     * @dev This is the function that the Chainlink nodes will call to see
     * if the lotery is ready to pick a winner
     * The following should be true ir order for upkeepNeeded to be true
     * 1. The time interval has passed between raffle runs
     * 2. The lotery is open
     * 3. The contract has ETH
     * 4. Implicity, your suscription has LINK
     * @param - ignored
     * @return upkeepNeeded - true if it's time to restart the lotery
     * @return - ignored
     */
    ...
    function performUpkeep(bytes calldata /* performData */) external {
        // chack if enough time has passed
